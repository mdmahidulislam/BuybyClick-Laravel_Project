...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $middleName = array(
        ...
        'Skovgaard', 'Søgaard', 'Aagaard', 'Berg', 'Dam', 'Petersen', 'Lind', 'Overgaard', 'Homet', 'Larsen', 'Bak', 'Schou',
    ...
    protected static $lastName = array(
        ...
        'Homet', 'Winther', 'Toft', 'Ravn', 'Mathiasen', 'Dam', 'Holst', 'Nilsson', 'Lind', 'Berg', 'Schou', 'Overgaard',
